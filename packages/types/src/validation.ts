...
export type PixelInput = z.input<typeof PixelSchema>;
export type PixelOutput = z.output<typeof PixelSchema>;
export type RoomCodeInput = z.input<typeof RoomCodeSchema>;
export type UsernameInput = z.input<typeof UsernameSchema>;
export type VoteInput = z.input<typeof VoteSchema>;
export type ZombieMoveInput = z.input<typeof ZombieMoveSchema>;
export type ZombieMoveDirection = z.infer<typeof ZombieMoveSchema>['direction'];
