...
<script lang="ts">
  ...
  function getErrorMessage(code: string): string {
    const messages: Record<string, string> = {
      ...
      'ALREADY_IN_GAME': $t.errors.alreadyInGame,
      'JOIN_FAILED': $t.errors.joinFailed,
      'ROOM_NOT_FOUND': $t.errors.roomNotFound,
      'WRONG_PASSWORD': $t.errors.wrongPassword,
      'PASSWORD_BLOCKED': $t.errors.passwordBlocked,
      'NOT_ENOUGH_PLAYERS': $t.errors.notEnoughPlayers,
      'KICKED': $t.errors.kicked,
      'IDLE_DISCONNECT': $t.errors.idleDisconnect,
      'INSTANCE_CLOSED': $t.errors.instanceClosed,
    };
...
<div class="app">
  ...
  <!-- Language Toggle - Only on start page (not in game) -->
  {#if !$lobby.instanceId}
  ...
  >
    ...
    <span class="github-text">{$t.github.openSource}</span>
  </a>
</div>
